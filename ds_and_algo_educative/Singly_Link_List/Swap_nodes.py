...
class LinkedList:
    ...
    def swap_nodes(self, key_1, key_2):
        ...
        if key_1 == key_2:   ## if keys same then no change in llist. it wil be same after swap so return
            return
        ...
        if not curr_1 or not curr_2:   # if keys not in LList then return,no change
            return
